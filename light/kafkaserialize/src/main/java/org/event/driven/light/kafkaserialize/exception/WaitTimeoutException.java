 ...
 * @author sharajava
 */
public class WaitTimeoutException extends SQLException {
     ...
     */
    public WaitTimeoutException(String reason, Throwable cause) {
        super(reason, cause);
    }
     ...
     * @param e the e
     */
    public WaitTimeoutException(Throwable e) {
        super(e);
    }
}
